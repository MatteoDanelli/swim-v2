	  ...
	  <div class="content">
		  <div class="description">
			  ...
			  <br> 		  
				...
				<p align="left"><h3> <a href="/Swimv2-Client/Guest/cerca_utenti.jsp"> Cerca aiuto </a> </h3> 
		   ...
		   <div class="box login">
				...
				<div class="box_contents">
					...
					Non sei ancora registrato? <a href="/Swimv2-Client/Guest/registrazione.jsp">Registrati! </a>
			</div> 
